...
from hummingbot.connector.exchange.payeer import (
    payeer_constants as CONSTANTS,
    payeer_utils as utils,
    payeer_web_utils as web_utils,
)
from hummingbot.connector.exchange.payeer.payeer_api_order_book_data_source import PayeerAPIOrderBookDataSource
from hummingbot.connector.exchange.payeer.payeer_api_user_stream_data_source import PayeerAPIUserStreamDataSource
...
class PayeerExchange(ExchangePyBase):
    """
    PayeerExchange connects with Payeer exchange and provides order book pricing, user account tracking and
    ...
    def __init__(
        ...
        :param payeer_api_key: The API key to connect to private Payeer APIs.
        :param payeer_secret_key: The API secret.
        :param trading_pairs: The market trading pairs which to track order book data.
        :param trading_required: Whether actual trading is needed.
        """
        self.payeer_api_key = payeer_api_key
        self.payeer_secret_key = payeer_secret_key
    ...
    def _create_order_book_data_source(self) -> OrderBookTrackerDataSource:
        return PayeerAPIOrderBookDataSource(
    ...
    def _create_user_stream_data_source(self) -> UserStreamTrackerDataSource:
        return PayeerAPIUserStreamDataSource(
            auth=self._auth,
            trading_pairs=self._trading_pairs,
            connector=self,
            api_factory=self._web_assistants_factory,
    ...
    async def _user_stream_event_listener(self):
        ...
        async for event_message in self._iter_user_event_queue():
            try:
                ...
                # Refer to https://payeer.github.io/payeer-pro-api/#channel-order-and-balance
                ...
                # We need to use the offline balance estimation for Payeer
